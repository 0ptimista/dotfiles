...
local on_attach = function(client, bufnr)
	...
	keymap.set("<cmd>Lspsaga code_action<CR>", "<leader>ca", "n", opts) -- see available code actions
...
lspconfig["yamlls"].setup({
	...
	settings = {
		yaml = {
			schemas = {
				["https://raw.githubusercontent.com/yannh/kubernetes-json-schema/master/v1.25.0/all.json"] = "/*.yaml",
				-- ["http://json.schemastore.org/kustomization"] = "/*.yaml",
			},
		},
	},
})
